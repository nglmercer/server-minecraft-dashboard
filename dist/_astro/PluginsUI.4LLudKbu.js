import{i as m,r as h}from"./lit-element.CdPzzhzS.js";import{E as b,x as c}from"./lit-html.Cs9YtZST.js";import{t as g}from"./custom-element.BhZVzxrc.js";import{n as p}from"./property.a2FlD-39.js";import{o as u}from"./map.DiiNQ3pp.js";var f=Object.defineProperty,y=Object.getOwnPropertyDescriptor,d=(t,i,e,n)=>{for(var s=n>1?void 0:n?y(i,e):i,r=t.length-1,a;r>=0;r--)(a=t[r])&&(s=(n?a(i,e,s):a(s))||s);return n&&s&&f(i,e,s),s};let o=class extends h{constructor(){super(...arguments),this.elements=[],this.type="plugins"}addElement(t){const i=typeof t=="string"?t:t.name;return this.elements.some(e=>(typeof e=="string"?e:e.name)===i)?!1:(this.elements=[...this.elements,t],!0)}removeElement(t){const i=typeof t=="string"?t:t.name,e=this.elements.length;return this.elements=this.elements.filter(n=>(typeof n=="string"?n:n.name)!==i),this.elements.length<e}_getItemName(t){return typeof t=="string"?t:t.name}_createItemHTML(t,i){const e=this._getItemName(t);if(!e)return console.warn("Item sin nombre:",t),b;const n=!e.toLowerCase().endsWith(".dis"),s=e.replace(/\.(jar|dis)$/i,"");return c`
    ...
    `;d([p({type:Array})],o.prototype,"elements",2);d([p({type:String})],o.prototype,"type",2);o=d([g("plugins-ui")],o);
