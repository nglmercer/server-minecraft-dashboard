 ...
 */const L=(e,t,r)=>{const a=new Map;for(let o=t;o<=r;o++)a.set(e[o],o);return a},j=S(class extends _{constructor(e){if(super(e),e.type!==C.CHILD)throw Error("repeat() can only be used in text expressions")}dt(e,t,r){let a;r===void 0?r=t:t!==void 0&&(a=t);const o=[],n=[];let i=0;for(const p of e)o[i]=a?a(p,i):i,n[i]=r(p,i),i++;return{values:n,keys:o}}render(e,t,r){return this.dt(e,t,r).values}update(e,[t,r,a]){const o=I(e),{values:n,keys:i}=this.dt(t,r,a);if(!Array.isArray(o))return this.ut=i,n;const p=this.ut??=[],u=[];let k,$,c=0,l=o.length-1,s=0,d=n.length-1;for(;c<=l&&s<=d;)if(o[c]===null)c++;else if(o[l]===null)l--;else if(p[c]===i[s])u[s]=m(o[c],n[s]),c++,s++;else if(p[l]===i[d])u[d]=m(o[l],n[d]),l--,d--;else if(p[c]===i[d])u[d]=m(o[c],n[d]),f(e,u[d+1],o[c]),c++,d--;else if(p[l]===i[s])u[s]=m(o[l],n[s]),f(e,o[c],o[l]),l--,s++;else if(k===void 0&&(k=L(i,s,d),$=L(p,c,l)),k.has(p[c]))if(k.has(p[l])){const b=$.get(i[s]),w=b!==void 0?o[b]:null;if(w===null){const D=f(e,o[c]);m(D,n[s]),u[s]=D}else u[s]=m(w,n[s]),f(e,o[c],w),o[b]=null;s++}else y(o[l]),l--;else y(o[c]),c++;for(;s<=d;){const b=f(e,u[d+1]);m(b,n[s]),u[s++]=b}for(;c<=l;){const b=o[c++];b!==null&&y(b)}return this.ut=i,R(e,u),O}});var P=Object.defineProperty,U=Object.getOwnPropertyDescriptor,B=(e,t,r,a)=>{for(var o=a>1?void 0:a?U(t,r):t,n=e.length-1,i;n>=0;n--)(i=e[n])&&(o=(a?i(t,r,o):i(o))||o);return a&&o&&P(t,r,o),o};let h=class extends M{constructor(){super(...arguments),this.backups=[],this.showActions=!0}formatFileSize(e){if(e===0)return"0 B";const t=1024,r=["B","KB","MB","GB","TB"],a=Math.floor(Math.log(e)/Math.log(t));return parseFloat((e/Math.pow(t,a)).toFixed(2))+" "+r[a]}formatDate(e){const t=new Date(e);return t.toLocaleDateString()+" "+t.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"})}handleAction(e,t){const r=new CustomEvent("backup-action",{detail:{action:e,item:t},bubbles:!0,composed:!0});this.dispatchEvent(r)}renderBackupItem(e){return g`
  ...
  `;B([z({type:Array})],h.prototype,"backups",2);B([z({type:Boolean})],h.prototype,"showActions",2);h=B([E("backup-list")],h);async function A(){const e=await v.getBackups();console.log("result",e);const t=e.data?.files;if(!t||t.length===0){console.log("No backups");return}return x&&(x.backups=t),e}async function N(e){console.log("backup",e);const t=await v.restoreBackups(e);return console.log("result",t),t}const x=document.getElementById("backups_List");function T(e){const t="-backup-",r=e.replace(/\.tar\.gz$/,""),a=r.indexOf(t);if(a===-1)return{name:r,date:"",fullFilename:e};const o=r.substring(0,a),n=r.substring(a+t.length);return{name:o,date:n,fullFilename:e}}async function Y(){x&&x.addEventListener("backup-action",async e=>{const{action:t,item:r}=e.detail;if(!t||!r)return;let a;switch(t){case"restore":const o={filename:r.name,outputFolderName:T(r.name).name};a=await N(o),console.log("result",a);break;case"download":const n=await v.downloadBackup(r.name);console.log("download",r),G(n,r.name);break;case"delete":a=await v.deleteBackup(r.name),console.log("delete",r),A();break;default:console.error("Acción no reconocida",t);break}console.log("action",t,r)})}function G(e,t){const r=window.URL.createObjectURL(e),a=document.createElement("a");a.href=r,a.download=t,document.body.appendChild(a),a.click(),document.body.removeChild(a),window.URL.revokeObjectURL(r)}document.addEventListener("DOMContentLoaded",()=>{Y(),A()});export{A as g};
