import{i as x,r as g}from"./lit-element.CdPzzhzS.js";import{x as C}from"./lit-html.Cs9YtZST.js";import{t as F}from"./custom-element.BhZVzxrc.js";/**
 * @license
 ...
 */function y(t,s){return(e,o,r)=>{const n=l=>l.renderRoot?.querySelector(t)??null;return T(e,o,{get(){return n(this)}})}}var A=Object.defineProperty,v=Object.getOwnPropertyDescriptor,b=(t,s,e,o)=>{for(var r=o>1?void 0:o?v(s,e):s,n=t.length-1,l;n>=0;n--)(l=t[n])&&(r=(o?l(s,e,r):l(r))||r);return o&&r&&A(s,e,r),r};let u=class extends g{constructor(){super(...arguments),this.obfuscators={},this.currId=0,this.lastProcessedText="",this.styleMap={"§0":"color:#000000","§1":"color:#0000AA","§2":"color:#00AA00","§3":"color:#00AAAA","§4":"color:#AA0000","§5":"color:#AA00AA","§6":"color:#FFAA00","§7":"color:#AAAAAA","§8":"color:#555555","§9":"color:#5555FF","§a":"color:#55FF55","§b":"color:#55FFFF","§c":"color:#FF5555","§d":"color:#FF55FF","§e":"color:#FFFF55","§f":"color:#FFFFFF","§l":"font-weight:bold","§m":"text-decoration:line-through","§n":"text-decoration:underline","§o":"font-style:italic"}}render(){return C`
    ...
    `;b([y("#console-text")],u.prototype,"consoleTextElem",2);u=b([F("game-console")],u);export{u as G};
