import"./custom-modal.CnXaXrgi.js";import{o as s}from"./CInput.DYPlFd8_.js";import{r as u,i as c}from"./lit-element.CdPzzhzS.js";import{T as k,x as a}from"./lit-html.Cs9YtZST.js";import{o as h}from"./map.DiiNQ3pp.js";import{e as $,i as _,t as w}from"./directive.CGE4aKEl.js";import{n as f}from"./property.a2FlD-39.js";import"./custom-element.BhZVzxrc.js";import"./state.Dj2gG79p.js";/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const x=$(class extends _{constructor(o){if(super(o),o.type!==w.ATTRIBUTE||o.name!=="class"||o.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(o){return" "+Object.keys(o).filter(e=>o[e]).join(" ")+" "}update(o,[e]){if(this.st===void 0){this.st=new Set,o.strings!==void 0&&(this.nt=new Set(o.strings.join(" ").split(/\s/).filter(i=>i!=="")));for(const i in e)e[i]&&!this.nt?.has(i)&&this.st.add(i);return this.render(e)}const t=o.element.classList;for(const i of this.st)i in e||(t.remove(i),this.st.delete(i));for(const i in e){const r=!!e[i];r===this.st.has(i)||this.nt?.has(i)||(r?(t.add(i),this.st.add(i)):(t.remove(i),this.st.delete(i)))}return k}});function S(o){try{if(Array.isArray(o)||typeof o=="object"&&o!==null)return o;if(typeof o=="string"&&(o.trim().startsWith("{")||o.trim().startsWith("[")))try{return JSON.parse(o)}catch{const t=o.replace(/([{,]\s*)(\w+)\s*:/g,'$1"$2":').replace(/:\s*'([^']+)'/g,': "$1"');return JSON.parse(t)}return o}catch(e){return console.error("Error al parsear JSON:",e,"Valor recibido:",o),o}}class V extends u{static get properties(){return{title:{type:String,reflect:!0},description:{type:String,reflect:!0},theme:{type:String,reflect:!0},options:{type:Array}}}constructor(){super(),this.title="",this.description="",this.theme="light",this.options=[]}static get styles(){return c`
      :host {
        --dlg-padding: 1.5rem;
    ...
    `}_handleOptionClick(e,t){this.options[t]?.callback&&typeof this.options[t].callback=="function"?this.options[t].callback(e):console.warn(`No valid callback found for option index ${t}`)}}class C extends u{static get properties(){return{visible:{type:Boolean,reflect:!0},required:{type:Boolean,reflect:!0}}}constructor(){super(),this.visible=!1,this.required=!1}static get styles(){return c`
      :host {
    ...
    `}render(){return this.toggleAttribute("invalid",!this._isValid),a`
    ...
    `}_renderInput(){const e="input-element";switch(this.type){case"textarea":return a`<textarea
          class=${e}
          id=${s(this.id)}
          name=${s(this.name)}
        ...
        ></textarea>`;case"checkbox":case"switch":case"boolean":return a`
          <label class="sw">
            <input
              class=${e}
              type="checkbox"
      ...
      >
        ${this.options.map(t=>{const i=this.multiple?Array.isArray(this._internalValue)&&this._internalValue.includes(String(t.value)):String(t.value)==String(this._internalValue??"");return a`
            <option
              value=${t.value}
              ?selected=${i}
            >${t.label}</option>
          `})}
      </select>`;case"radio":return a`
  ...
  `;static properties={itm:{type:Object},fCfg:{type:Object},cActs:{type:Array},darkmode:{type:Boolean,reflect:!0},_iItm:{state:!0},_cItm:{state:!0}};constructor(){super(),this.itm={},this._iItm={},this._cItm={},this.fCfg={},this.cActs=[],this.darkmode=!1}willUpdate(e){if(e.has("itm")){const t=this._deepCopy(this.itm);JSON.stringify(t)!==JSON.stringify(this._cItm)&&(this._cItm=t,this._iItm=this._deepCopy(t))}}_deepCopy(e){try{return JSON.parse(JSON.stringify(e||{}))}catch(t){return console.error("Err deep copy",t),{}}}setConfig(e={},t={}){this.itm=this._deepCopy(e),this.fCfg=t||{},this.requestUpdate()}setItem(e={}){this.itm=this._deepCopy(e),this.requestUpdate()}addAct(e,t,i=""){!e||typeof e!="string"||typeof t!="string"||(this.cActs=[...this.cActs.filter(r=>r.nm!==e),{nm:e,lbl:t,cls:i}])}validate(){let e=!0;return this.shadowRoot.querySelectorAll("c-inp").forEach(t=>{const i=t.closest(".fld-wrp");if(i?.classList.contains("hidden")){i?.classList.remove("inv");return}let r=!0;typeof t.isValid=="function"&&(r=t.isValid()),i?.classList.toggle("inv",!r),r||(e=!1)}),e}getData(){return this._deepCopy(this._cItm)}reset(){this._cItm=this._deepCopy(this._iItm),this.requestUpdate(),this.shadowRoot.querySelectorAll(".fld-wrp.inv").forEach(e=>e.classList.remove("inv")),this.shadowRoot.querySelectorAll("c-inp").forEach(e=>{typeof e.isValid=="function"&&e.isValid()})}_hInpChg(e){if(e.target.tagName!=="C-INP")return;let t,i;e.detail?.name!==void 0?{name:t,value:i}=e.detail:(t=e.target.name,t&&typeof e.target.getVal=="function"&&(i=e.target.getVal())),t!==void 0&&(this._cItm[t]!==i&&(this._cItm={...this._cItm,[t]:i},this.dispatchEvent(new CustomEvent("fld-chg",{detail:{n:t,v:i}}))),e.target.closest(".fld-wrp")?.classList.remove("inv")),console.log("Input:",t,"Value:",i)}_hSub(e){e.preventDefault(),this._hSave()}_hActClk(e){const t=e.target.closest("button[data-act]");if(!t)return;const i=t.dataset.act;i==="save"||(i==="cancel"?(this.dispatchEvent(new CustomEvent("cancel-edit")),this.reset()):this.dispatchEvent(new CustomEvent(i,{detail:this.getData()})))}_hSave(){if(this.validate()){const e=this.getData();this._iItm=this._deepCopy(e),this.dispatchEvent(new CustomEvent("save-item",{detail:e}))}else{const e=this.shadowRoot.querySelector(".fld-wrp:not(.hidden).inv c-inp");if(e)try{typeof e.focus=="function"?e.focus():e.shadowRoot?.querySelector("input, select, textarea")?.focus()}catch(t){console.warn("Cant focus inv fld",t)}}}_compareValues(e,t){return typeof t=="boolean"?!(["false","0","",null,void 0].includes(String(e).toLowerCase())||!e)===t:e==null?t==null||t==="":String(e)===String(t)}_shouldFieldBeVisible(e,t){const i=t.showIf;if(!i||!i.field)return!0;const r=i.field,l=this._cItm?.[r],n=i.value,d=i.negate===!0;let p;return Array.isArray(n)?p=n.some(v=>this._compareValues(l,v)):p=this._compareValues(l,n),d?!p:p}render(){return a`
          <form class="ef-cont" @submit=${this._hSub} novalidate>
              ...
              <div class="acts" @click=${this._hActClk}>
                  ...
                  ${h(this.cActs||[],e=>a`
                      <button type="button" data-act=${e.nm} class=${s(e.cls)}>${e.lbl}</button>
                  `)}
              </div>
          </form>
      `}}customElements.define("obj-edit-frm",E);class O extends u{static styles=c`
      /* Estilos (sin cambios) */
  ...
  `;static properties={mode:{type:String},itm:{type:Object},fCfg:{type:Object},hdrKey:{type:String,attribute:"hdr-key",reflect:!0},cActs:{type:Array},darkmode:{type:Boolean,reflect:!0}};constructor(){super(),this.mode="display",this.itm={},this.fCfg={},this.cActs=[{nm:"delete",lbl:"Eliminar",cls:"del-btn"}],this.darkmode=!1}_deepCopy(e){try{return JSON.parse(JSON.stringify(e||{}))}catch(t){return console.error("Err deep copy",t),{}}}setConfig(e={},t={}){this.itm=this._deepCopy(e),this.fCfg=t||{},this.mode="display"}setItem(e={}){this.itm=this._deepCopy(e),this.mode==="edit"&&this.requestUpdate()}addAct(e,t,i=""){!e||typeof e!="string"||typeof t!="string"||(this.cActs=[...this.cActs.filter(r=>r.nm!==e),{nm:e,lbl:t,cls:i}])}hideAct(e){this.hiddenAct(e)}hiddenAct(e){!e||typeof e!="string"||(this.cActs=this.cActs.filter(t=>t.nm!==e))}_formatVal(e,t){const i=t.type||"text";if(i==="boolean"||i==="switch"||i==="checkbox")return e?t.trueLabel||"Yes":t.falseLabel||"No";if(i==="select"&&Array.isArray(t.options)){const r=t.options.find(l=>String(l.value)===String(e));return r?r.label:e??""}return e==null?"":String(e)}_hDispActClk(e){const t=e.target.closest("button[data-act]");if(!t)return;const i=t.dataset.act,r=this._deepCopy(this.itm);i==="edit"?this.mode="edit":i==="delete"?this.dispatchEvent(new CustomEvent("del-item",{detail:r})):this.dispatchEvent(new CustomEvent(i,{detail:r}))}_hSave(e){this.itm=this._deepCopy(e.detail),this.dispatchEvent(new CustomEvent("item-upd",{detail:this._deepCopy(this.itm)})),this.mode="display"}_hCancel(){this.mode="display"}_compareValues(e,t){return typeof t=="boolean"?!(["false","0","",null,void 0].includes(String(e).toLowerCase())||!e)===t:e==null?t==null||t==="":String(e)===String(t)}_shouldFieldBeVisible(e,t,i){const r=t.showIf;if(!r||!r.field)return!0;const l=r.field,n=i?.[l],d=r.value,p=r.negate===!0;let b;return Array.isArray(d)?b=d.some(v=>this._compareValues(n,v)):b=this._compareValues(n,d),p?!b:b}_renderDisp(){const e=this.hdrKey&&this.itm[this.hdrKey]!==void 0?this.itm[this.hdrKey]:null;return a`
        <div class="d-card">
            ${e!==null?a`<div class="d-hdr">${e}</div>`:""}
            <div class="d-cont">
                ${h(Object.entries(this.fCfg||{}),([t,i])=>{const r=this._shouldFieldBeVisible(t,i,this.itm);return i.hidden||t===this.hdrKey||!r?"":a`
                        <div class="d-prop">
            ...
            <div class="d-acts" @click=${this._hDispActClk}>
                 ...
                 ${h(this.cActs||[],t=>a`
                    <button type="button" data-act=${t.nm} class=${s(t.cls)}>${t.lbl}</button>
                 `)}
            </div>
        </div>
    `}_renderEdit(){return a`
          <obj-edit-frm
              .fCfg=${this.fCfg}
              .itm=${this.itm}
              .cActs=${[]}
          ...
          ></obj-edit-frm>
      `}render(){return!this.itm||!this.fCfg||Object.keys(this.fCfg).length===0?a`<p>No item/config.</p>`:a`
          <div class="dyn-cont">
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */function y(o,e,t){return o?e(o):t?.(o)}var I=Object.defineProperty,m=(o,e,t,i)=>{for(var r=void 0,l=o.length-1,n;l>=0;l--)(n=o[l])&&(r=n(e,t,r)||r);return r&&I(e,t,r),r};class g extends u{constructor(){super(...arguments),this.options=[],this.Values=[],this.multiple=!1,this.grid=!1}updated(e){if(e.has("multiple")){const t=e.get("multiple");t!==void 0&&this.multiple!==t&&(this.Values=[],this._dispatchChange([]))}(e.has("options")||e.has("Values"))&&this._validateSelection()}_validateSelection(){const e=new Set(this.options.map(l=>String(l.value))),r=(Array.isArray(this.Values)?this.Values:[this.Values]).map(String).filter(l=>e.has(l));console.log("newSelectedValues",r),r.length!==this.Values?.length&&(this.Values=r,this._dispatchChange(this.getSelectedOptions()))}_handleOptionSelect(e){e&&(this.multiple?this._toggleOption(e):this._selectOption(e))}_toggleOption(e){const t=this.Values.indexOf(e);let i;t===-1?i=[...this.Values,e]:i=this.Values.filter(r=>r!==e),this.Values=i,this._dispatchChange(this.getSelectedOptions())}_selectOption(e){this.Values.length===1&&this.Values[0]===e||(this.Values=[e],this._dispatchChange(this.getSelectedOptions()))}_dispatchChange(e){this.dispatchEvent(new CustomEvent("change",{detail:e,bubbles:!0,composed:!0}))}getSelectedOptions(){if(!this.options||this.options.length===0)return this.multiple?[]:null;const e=new Set(this.Values?.map(String)),t=this.options.filter(i=>e.has(String(i.value)));return this.multiple?t:t[0]||null}setOptions(e){this.options=e||[]}setSelectedValues(e){const t=Array.isArray(e)?e:e!=null?[String(e)]:[],i=new Set(this.options.map(r=>String(r.value)));this.Values=t.map(String).filter(r=>i.has(r))}getValue(){return this.multiple?[...this.Values]:this.Values.length>0?this.Values[0]:null}}m([f({type:Array})],g.prototype,"options");m([f({type:Array})],g.prototype,"Values");m([f({type:Boolean,reflect:!0})],g.prototype,"multiple");m([f({type:Boolean,reflect:!0})],g.prototype,"grid");class q extends g{static{this.styles=c`
    :host {
      display: inherit;
  ...
  `}_handleOptionClick(e){const i=e.currentTarget.dataset.value;i&&this._handleOptionSelect(i)}render(){const e=this.getSelectedOptions();return a`
    ...
    `}generateSelectorOptions(){return Array.from(h(this.options,e=>{const t=this.Values?.includes(String(e.value)),i=x({option:!0,selected:t});return a`
          <div
            class=${i}
            data-value=${e.value}
            ...
            tabindex="0"
          >
            ${y(e.img,()=>a`<img src="${e.img}" alt="">`)}
            <span class="option-label">${e.label}</span>
            ${y(e.state,()=>a`<span class="option-state">${e.state}</span>`)}
          </div>
        `}))}_renderPreview(e){}}class j extends g{static{this.styles=c`
    :host {
      display: block;
    }
    .cards-grid {
  ...
  `}selectCard(e){this._handleOptionSelect(e)}render(){return a`
    ...
    `}generateSelectorOptions(){return Array.from(h(this.options,e=>{const t=this.Values.includes(String(e.value));return a`
          <div
            class="card ${t?"active":""}"
            data-value="${e.value}"
            @click="${()=>this.selectCard(String(e.value))}"
          >
            <img class="icon" src="${e.img||""}" alt="${e.label}" />
