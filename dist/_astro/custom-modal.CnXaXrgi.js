import{i as g,r as p}from"./lit-element.CdPzzhzS.js";import{E as u,T as b,x as l}from"./lit-html.Cs9YtZST.js";import{e as v,i as f,t as m}from"./directive.CGE4aKEl.js";import{t as y}from"./custom-element.BhZVzxrc.js";import{n as k}from"./property.a2FlD-39.js";import{r as h}from"./state.Dj2gG79p.js";/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class c extends f{constructor(t){if(super(t),this.it=u,t.type!==m.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===u||t==null)return this._t=void 0,this.it=t;if(t===b)return t;if(typeof t!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.it)return this._t;this.it=t;const o=[t];return o.raw=o,this._t={_$litType$:this.constructor.resultType,strings:o,values:[]}}}c.directiveName="unsafeHTML",c.resultType=1;const x=v(c);var w=Object.defineProperty,_=Object.getOwnPropertyDescriptor,a=(e,t,o,r)=>{for(var i=r>1?void 0:r?_(t,o):t,s=e.length-1,d;s>=0;s--)(d=e[s])&&(i=(r?d(t,o,i):d(i))||i);return r&&i&&w(t,o,i),i};class C extends p{static get properties(){return{title:{type:String,reflect:!0},description:{type:String,reflect:!0},theme:{type:String,reflect:!0},options:{type:Array}}}constructor(){super(),this.title="",this.description="",this.theme="light",this.options=[]}static get styles(){return g`
      :host {
        --dlg-padding: 1.5rem;
