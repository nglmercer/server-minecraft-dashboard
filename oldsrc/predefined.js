...
const Constants = {
    PERMISSIONS,
    MONITOR_SERVERS_PERM_URLS: [
        { url: "/", method: "GET" },
        { url: /\/.*\/log/gi, method: "GET" },
        { url: /\/.*\/icon/gi, method: "GET" },
        { url: /\/.*\/info/gi, method: "GET" },
        { url: /\/.*\/query/gi, method: "GET" },
        { url: /\/.*\/startScript/gi, method: "GET" },
        { url: /\/.*\/server.properties/gi, method: "GET" }
    ],
    BASE_DIRS: ["backups", "logs", "servers", "binaries", "binaries/java"],
    TASKS_TYPES: {
    ...
    KUBEK_LOGO_ASCII: `
      ...
      ╚═╝     ╚═╝╚═╝╚═╝  ╚═══╝╚══════╝ ╚═════╝ ╚═╝  ╚═╝ ╚═╝  ╚═╝    ╚═╝   
    `,
    UPDATES_URL_API: "https://api.github.com/repos/Seeroy/kubek-minecraft-dashboard/releases",
    STATS_SEND_URL: "https://statscol.seeeroy.ru/save_kubek?savedata=",
    SPIGOT_JSON_URL: "https://kubek.seeeroy.ru/spigots.json",
    JAVA_LIST_URL: "https://api.adoptium.net/v3/info/available_releases",
    ...
    DEFAULT_KUBEK_PASSWORD: "Kubek2024",
    TASK_STATUS: {
    ...
    PASSWORD_REGEX: /^(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?=.*[a-zA-Z]).{6,64}$/g,
    LOGIN_REGEX: /^[a-zA-Z0-9_.-]{3,16}$/g,
    ...
    NO_LOG_URLS: [
        /\/api\/tasks.*/gi,
        /\/api\/servers.*\/icon.*/gi,
        /\/api\/servers.*\/query/gi,
        /\/api\/servers.*\/info/gi,
        /\/api\/servers.*\/log/gi,
        "/api/fileManager/chunkWrite/add",
        "/api/servers",
        /.*\.woff2/gi,
        /.*\.js/gi,
        /.*\.css/gi,
    ...
    ALLOWED_STATIC_EXTS: ["html", "css", "js", "json", "png", "ico", "svg", "jpg", "jpeg", "xml", "txt", "eof", "woff", "woff2", "ttf"],
    TRANSLATION_STATIC_EXTS: ["html", "js", "txt", "json"],
    SKIP_AUTH_URLS: [
        /\/api\/auth\/login\/.*\/.*/gi,
        /\/login.html/gi,
        /\/assets\/.*/gi,
